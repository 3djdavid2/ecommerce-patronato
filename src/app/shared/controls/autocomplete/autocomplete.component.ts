...
export class AutocompleteComponent implements OnInit, OnDestroy, ControlValueAccessor {
  ...
  //a los objetos de tipo observable se le pone un sigo $ al final:
  ...
  //metodos de propagacion privada
...
// OnSestroy para eliminar las suscripciones activas